            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <select v-model="country" @change="getRegions(country)" class="form-select" id="countries">
                        <option selected :value="null">Open this to select country</option>
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <select v-model="region" @change="getProvince(region)" class="form-select" id="region">
                        <option selected :value="null">Open this to select region</option>
            ...
            <div class="col-md-5">
                <div class="mb-3">
                    ...
                    <select v-model="province" @change="getCity" class="form-select" id="province">
                        <option selected :value="null">Open this to select province</option>
            ...
            <div class="col-md-5">
                <div class="mb-3">
                    ...
                    <select v-model="city" class="form-select" id="city">
                        <option selected :value="null">Open this to select city</option>
